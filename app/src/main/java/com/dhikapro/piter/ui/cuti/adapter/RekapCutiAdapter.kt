package com.dhikapro.piter.ui.cuti.adapter
...
import com.dhikapro.piter.ui.cuti.DetailCutiActivity
import com.dhikapro.piter.ui.lembur.DetailLemburActivity

class RekapCutiAdapter(private val context: Context): RecyclerView.Adapter<RekapCutiAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_cuti, parent, false)
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.edit.setOnClickListener {
            val intent = Intent(holder.itemView.context, DetailCutiActivity::class.java)
